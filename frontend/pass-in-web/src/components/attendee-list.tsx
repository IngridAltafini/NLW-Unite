        ...
        <table className="w-full ">
          <thead>
            <tr className="border-b border-white/10">
              ...
              <th className="py-3 px-4 text-sm font-semibold text-left">Data de inscricao</th>
            ...
            {Array.from({ length: 9 }).map((_, i) => {
              return (
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-300">1323424</td>
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <div className="flex flex-col gap-1">
                      <span className="font-semibold text-white">Ingrid Altafini</span>
                      <span>ingridaltafini225@gmail.com</span>
                    </div>
                  </td>
